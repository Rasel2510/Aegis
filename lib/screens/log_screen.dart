    ...
    return GestureDetector(
      ...
      child: AnimatedContainer(
        ...
        decoration: BoxDecoration(
          color: active ? color.withValues(alpha: 00.15) : Colors.transparent,
          border: Border.all(
              color: active ? color : Colors.grey.withValues(alpha: 00.4)),
        ...
        children: [
          Icon(
            isFiltered
                ...
                : Icons.dns_outlined,
            size: 56,
            color: Colors.grey.withValues(alpha: 00.4),
          ),
