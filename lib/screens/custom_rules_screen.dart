    ...
    return Scaffold(
      ...
      body: TabBarView(controller: _tabs, children: [
        _RuleTab(
          ...
          onAdd: _addBlock,
          subtitle:
              'These domains are always blocked, even if not in the main list.',
        ),
        _RuleTab(
          label: 'Allow',
          color: Colors.green,
          ...
          onAdd: _addAllow,
          subtitle:
              'These domains are never blocked, even if in the main list.',
        ),
      ]),
    );
  }
      ...
      child: Column(children: [
        ...
        Expanded(
            child: domains.isEmpty
                ? Center(
                    child: Text('No custom $label rules yet',
